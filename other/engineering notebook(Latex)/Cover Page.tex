...
\usepackage{MINDCRAFT FE Report} % DO NOT REMOVE THIS LINE. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            {\large 
                ...
                %%%%%%%%%%%%%%%%%%%%%%%%%%%%             
                % change the following line                
                \emph{Team Coach:} Soufiane ELHATRI}\\[1cm] % if applicable
            
    		% PLEASE DO NOT CHANGE THIS TEXT %
            \large Taha TAIDI LAAMIRI\\Salmane DERDEB\\Mortada TAIDI LAAMIRI\\
            %%%
